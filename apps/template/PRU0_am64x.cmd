...
MEMORY
{
   ...
   * 3 kB LUT
   *
   * Important: must be paged aligned (increments of 4096)
   */

  /* 56KB shared state */
  PRU_SHAREDMEM   : org = 0x00010000 len = 0x0000E000 CREGISTER=28

  /* 4KB parameters */
  PRU_PARAM       : org = 0x0001E000 len = 0x00001000 CREGISTER=29

  /* 4 kB LUT */
  PRU_LUTAB       : org = 0x0001F000 len = 0x00001000 CREGISTER=30
