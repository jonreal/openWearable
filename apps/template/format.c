...
const ow_field_t ow_schema[] = {
  ...
  { "cpuvar",   OW_U32,   offsetof(state_t, cpu_state.cpuvar)   },
  { "nn_y0",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[0])  },
  { "nn_y1",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[1])  },
  { "nn_y2",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[2])  },
  { "nn_y3",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[3])  },
  { "nn_y4",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[4])  },
  { "nn_y5",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[5])  },
  { "nn_y6",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[6])  },
  { "nn_y7",    OW_FIX16, offsetof(state_t, cpu_state.nn.y[7])  },
