...
int main(void)
{
  ...
  while(1){
    ...
    /* Set index and write buffer */
    p->flow_control_bit.stateIndx = (uint16_t) stateIndx;
    p->flow_control_bit.writeBuffer = (unsigned) buffIndx;
